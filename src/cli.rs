//! cli
//!
//! Command line entry point shared by the `rusync` and `rusync2` binaries.
...
use crate::console_info::announce_next_sync;
use crate::console_info::sleep_with_progress;
